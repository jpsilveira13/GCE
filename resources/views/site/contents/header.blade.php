...
<nav class="navbar navbar-expand-lg fixed-top text-uppercase" id="mainNav">
    ...
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="{{url('site/img/logo-header.png')}}" alt="logo" /> </a>
...
<div class="menu-selecao-idioma">
    <div style="width: 100%;background-color: transparent;"></div>
    <div>
        <div class="languageSelect" data-value="en">
            <h3>EUA</h3>
            <h3>United States</h3></div>
        <div  class="languageSelect" data-value="pt">
            <h3>BR</h3>
            <h3>Brazil</h3>
        </div>
